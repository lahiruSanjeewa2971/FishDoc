...
export default class Breeding extends React.Component {
  constructor(props) {
    super(props);
      ...
      this.uploadImage(this.state.localUri,this.guidGenerator()+"_"+currentDate).then(async(imageUrl) => {
        ...
        await axios.post(url,data,{
            ...
            if(res.data['data']['success']=="true"){
              this.setState({name:res.data['data']['main'],type:res.data['data']['sub'],accuracy:res.data['data']['accuracy'],nextBtn: true})
  ...
  next=()=>{
    this.props.navigation.navigate("BreedingGender",{ name:this.state.name.toLowerCase()})
  }
